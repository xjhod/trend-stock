...
# ===== 1. 扫描 =====
SCAN_DATE = "2026-04-15"; END_DATE = "2026-06-14"
ASOF = SCAN_DATE
...
json.dump(out, open(os.path.join(BASE, "research", "bt_0415_v3_result.json"), "w", encoding="utf-8"), ensure_ascii=False, indent=1)
print(f"\n结果已保存: research/bt_0415_v3_result.json")
